...
- [x] 将筛选出的十篇综述尽可能下载到本地，保存PDF或可读文本，并整理准确本地路径清单
  Done when: 产出 `projects/multi-agent-survey-review/literature/meta/2026-03-26-selected-10-download-manifest.json` 与 `projects/multi-agent-survey-review/literature/meta/2026-03-26-selected-10-local-paths.md`；并通过 `python3` 校验 manifest 中 10/10 条记录 `exists=True`、`status=downloaded`、`missing_count=0`
...
- [x] 检索并收集可支撑该课程路线的高质量资料与综述来源，优先整理可追溯链接、标题、摘要与适用章节
  Done when: 产出 `projects/multi-agent-survey-review/sources/2026-03-26-course-route-supporting-high-quality-sources.md`，并完成 `projects/multi-agent-survey-review/plans/检索并收集可支撑该课程路线的高质量资料与综述来源-优先整理可追溯链接-标题-摘要与适用章节-progress.md`、`projects/multi-agent-survey-review/plans/检索并收集可支撑该课程路线的高质量资料与综述来源-优先整理可追溯链接-标题-摘要与适用章节-self-review.md`、`projects/multi-agent-survey-review/plans/检索并收集可支撑该课程路线的高质量资料与综述来源-优先整理可追溯链接-标题-摘要与适用章节-summary.md`

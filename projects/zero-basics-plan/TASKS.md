...
- [x] 基于上述调研结果，设计一个 28 天、4 周的完整课程大纲：每天有学习目标、任务安排、详细学习资料、实践内容；每周末安排一次系统课程，用于回顾、串联和综合练习。
  Done when: 已产出 `projects/zero-basics-plan/analysis/2026-03-26-28-day-course-outline.md`，覆盖 4 周 28 天、统一日课模板、每周系统课程、阶段成果目标、资料来源格式与多 Agent 拆分建议。

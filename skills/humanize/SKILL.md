...
```bash
/home/devcontainers/.cursor/skills/humanize
```

All command examples below use `/home/devcontainers/.cursor/skills/humanize`.
...
- In skill mode, always run `/home/devcontainers/.cursor/skills/humanize/scripts/rlcr-stop-gate.sh` to enforce hook-equivalent transitions and blocking
...
```bash
"/home/devcontainers/.cursor/skills/humanize/scripts/cancel-rlcr-loop.sh"
# or force cancel during finalize phase
"/home/devcontainers/.cursor/skills/humanize/scripts/cancel-rlcr-loop.sh" --force
```
...
"/home/devcontainers/.cursor/skills/humanize/scripts/setup-pr-loop.sh" --claude

# Monitor chatgpt-codex-connector[bot] reviews
"/home/devcontainers/.cursor/skills/humanize/scripts/setup-pr-loop.sh" --codex
...
```bash
"/home/devcontainers/.cursor/skills/humanize/scripts/cancel-pr-loop.sh"
```

### Generate Plan from Draft

```bash
"/home/devcontainers/.cursor/skills/humanize/scripts/validate-gen-plan-io.sh" --input path/to/draft.md --output path/to/plan.md
```
...
```bash
"/home/devcontainers/.cursor/skills/humanize/scripts/ask-codex.sh" [--codex-model MODEL:EFFORT] [--codex-timeout SECONDS] "your question"
```
